...
public partial class CaseRequestModel
{
    [JsonPropertyName("SR_NUM")]
    ...
    public virtual string? CrmCategory { get; set; }

    public virtual string? CrmProduct { get; set; }

    public virtual string? CrmStatus { get; set; }

    public virtual string? CrmSubType { get; set; }

    public virtual string? CrmType { get; set; }
}
