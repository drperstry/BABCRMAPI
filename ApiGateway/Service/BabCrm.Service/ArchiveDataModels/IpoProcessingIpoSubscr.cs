...
public partial class IpoProcessingIpoSubscr
{
    ...
    public string? ActiveIpoName { get; set; }

    public decimal? SharePerSubscriber { get; set; }

    public string? LegalMessageConfirmation { get; set; }
